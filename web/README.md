...
- `index.html` — landing page with the "Télécharger l'APK" button (links to the fixed `best-radio.apk` GitHub Release asset — the signed release build — so this link never needs updating across releases).
