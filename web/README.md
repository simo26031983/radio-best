...
- `index.html` — landing page with the "Télécharger l'APK" button (links to the fixed `best-radio.apk` GitHub Release asset — the signed release build published by `.github/workflows/android-release.yml` — so this link never needs updating across releases).
